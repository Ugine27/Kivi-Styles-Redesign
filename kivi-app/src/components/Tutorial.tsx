        ...
        <div className="flex flex-col items-start justify-center -mt-8 max-w-4xl text-left">
          ...
          <div className="border-l-4 border-[#8d6e63]/30 pl-8 ml-2">
            ...
            <p className="text-xl text-[#3e2723]/70 font-sans mb-6 leading-relaxed">
              WhisPURR stays quietly in the background as you move between contexts. Speak naturally, and it adapts your words to where you are — so you spend less time switching, rephrasing, and managing AI.
            </p>
            <p className="text-2xl text-[#3e2723] font-serif font-bold italic">
              Fast. Flexible. Quietly there.
            </p>
          </div>
          <div className="mt-16 self-center w-32 h-32 bg-[#3e2723] rounded-full flex items-center justify-center shadow-[0_0_80px_rgba(141,110,99,0.3)]">
